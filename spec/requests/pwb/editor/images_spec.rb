  ...
  RSpec.describe "Editor::Images", type: :request do
    ...
    describe "GET /editor/images" do
      it "returns a list of images" do
        ...
        content_photo.image.attach(io: File.open(file_path), filename: 'flat_balcony.jpg', content_type: 'image/jpeg') unless content_photo.image.attached?
    ...
    describe "POST /editor/images" do
      it "uploads an image" do
        ...
        end.to change(Pwb::ContentPhoto, :count).by(1)
