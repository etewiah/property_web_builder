...
# Previews for Feature page parts
# Sections showcasing features, services, or benefits
#
# @label Features
class PageParts::FeaturesPreview < Lookbook::Preview
  include PagePartPreviewHelper

  # 3-Column Feature Grid
  # Three feature cards in a grid layout with icons
  #
  # @label Feature Grid (3-Column)
  # @param theme select { choices: [default, brisbane, bologna, brussels] }
  def feature_grid_3col(theme: "default")
    page_part = build_page_part("features/feature_grid_3col")
    
    render_liquid_template("features/feature_grid_3col", page_part, theme)
  end

  # 4-Column Icon Cards
  # Four icon cards with colored backgrounds
  #
  # @label Feature Cards (Icons)
  # @param theme select { choices: [default, brisbane, bologna, brussels] }
  def feature_cards_icons(theme: "default")
    page_part = build_page_part("features/feature_cards_icons")
    
    render_liquid_template("features/feature_cards_icons", page_part, theme)
  end
