...
# Previews for Testimonial page parts
# Customer reviews and testimonials
#
# @label Testimonials
class PageParts::TestimonialsPreview < Lookbook::Preview
  include PagePartPreviewHelper

  # Testimonial Carousel
  # Sliding carousel of customer testimonials
  #
  # @label Testimonial Carousel
  # @param theme select { choices: [default, brisbane, bologna, brussels] }
  def testimonial_carousel(theme: "default")
    page_part = build_page_part("testimonials/testimonial_carousel")
    
    render_liquid_template("testimonials/testimonial_carousel", page_part, theme)
  end

  # Testimonial Grid
  # Grid of testimonial cards with ratings
  #
  # @label Testimonial Grid
  # @param theme select { choices: [default, brisbane, bologna, brussels] }
  def testimonial_grid(theme: "default")
    page_part = build_page_part("testimonials/testimonial_grid")
    
    render_liquid_template("testimonials/testimonial_grid", page_part, theme)
  end
