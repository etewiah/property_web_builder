...
module Pwb
  RSpec.describe 'ContentTranslationsSeeder' do
    ...
    it 'sets sort order correctly' do
      ...
      our_agency_content = about_us_page.contents.find_by_fragment_key our_agency_content_key
      ...
      content_html_content = about_us_page.contents.find_by_fragment_key content_html_content_key
    ...
    it 'creates our_agency html content' do
      ...
      about_us_page_content = about_us_page.contents.find_by_fragment_key content_key
