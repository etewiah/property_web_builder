Pwb::Engine.routes.draw do
  ...
  devise_for :users, class_name: "Pwb::User", only: :omniauth_callbacks, controllers: { omniauth_callbacks: 'omniauth_callbacks' }
  ...
  scope "(:locale)", locale: /#{I18n.available_locales.join("|")}/ do
    ...
    devise_for :users, skip: :omniauth_callbacks, class_name: "Pwb::User", module: :devise, :controllers => { :registrations => "pwb/devise/registrations", omniauth_callbacks: 'omniauth_callbacks' }
