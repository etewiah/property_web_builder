module Pwb
  # Property is a read-only model backed by a materialized view.
  # It denormalizes pwb_realty_assets + pwb_sale_listings + pwb_rental_listings
  # into a single queryable interface that matches the old Pwb::Prop model.
  #
  ...
  #
  # After writes, call Pwb::Property.refresh to update the materialized view.
  #
