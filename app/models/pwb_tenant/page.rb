...
module PwbTenant
  class Page < ApplicationRecord
    ...
    has_many :links, class_name: 'PwbTenant::Link', foreign_key: 'page_slug', primary_key: 'slug'
    has_one :main_link, -> { where(placement: :top_nav) }, foreign_key: 'page_slug', primary_key: 'slug', class_name: 'PwbTenant::Link'

    has_many :page_parts, class_name: 'PwbTenant::PagePart', foreign_key: 'page_slug', primary_key: 'slug'
