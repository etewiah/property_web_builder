  ...
  <div>
    <q-card class="listings-summary-card">
      ...
      <router-link style="text-decoration: none" :to="currentListingRoute">
        <q-expansion-item
          class="full-width summ-card-exp-item"
          :header-style="{ width: '100%' }"
          :label="currentListing.title"
          @show="startExpandDetails"
          @hide="stopExpandDetails"
          v-model="cardExpansionState"
        >
              ...
              >
                ...
                <q-item-label caption>
                  <!-- <ConvertableCurrencyDisplay
                    :priceInCents="currentListing.price_sale_current_cents"
